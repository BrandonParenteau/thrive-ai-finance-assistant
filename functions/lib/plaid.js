...
exports.plaidDone = exports.plaidSyncTransactions = exports.plaidExchangeToken = exports.plaidLink = exports.plaidLinkToken = void 0;
...
function makePlaidClient(clientId, secret) {
...
exports.plaidLinkToken = (0, https_1.onRequest)({
    region: "us-central1",
    cors: false,
}, async (req, res) => {
    setCors(res);
    ...
    try {
        ...
        const linkResp = await plaid.linkTokenCreate({
            ...
            country_codes: [plaid_1.CountryCode.Ca],
            language: "en",
...
exports.plaidLink = (0, https_1.onRequest)({
    secrets: [],
    region: "us-central1",
    cors: false,
}, async (req, res) => {
...
exports.plaidExchangeToken = (0, https_1.onRequest)({
    timeoutSeconds: 120,
    memory: "512MiB",
    region: "us-central1",
    cors: false,
...
exports.plaidSyncTransactions = (0, https_1.onRequest)({
    timeoutSeconds: 120,
    memory: "512MiB",
    region: "us-central1",
    cors: false,
    ...
    try {
        ...
        for (const itemDoc of itemsSnap.docs) {
            ...
            const institutionName = itemData.institution_name || "Bank";
            let offset = 0;
            while (true) {
                const txResp = await plaid.transactionsGet({
                    access_token,
...
exports.plaidDone = (0, https_1.onRequest)({ region: "us-central1", cors: false }, (_req, res) => {
    res.setHeader("Content-Type", "text/html; charset=utf-8");
    res.send(`<!DOCTYPE html>
<html>
<head>
