...
exports.monthlySummaryEmail = void 0;
/**
...
exports.monthlySummaryEmail = (0, scheduler_1.onSchedule)({
    ...
    const promises = usersSnap.docs.map(async (userDoc) => {
        try {
            ...
            if (!userData.monthly_summary_enabled)
                return;
            ...
            const expenses = Math.abs(prevTxs
                .filter((t) => (t.amount ?? 0) < 0)
                .reduce((s, t) => s + (t.amount ?? 0), 0));
            ...
            const accSnap = await db
                ...
                .collection("accounts")
                .get();
            const netWorth = accSnap.docs.reduce((s, d) => s + (d.data().balance ?? 0), 0);
            // Top categories
            const categoryMap = {};
            prevTxs
                .filter((t) => (t.amount ?? 0) < 0)
...
//# sourceMappingURL=monthlySummaryEmail.js.map